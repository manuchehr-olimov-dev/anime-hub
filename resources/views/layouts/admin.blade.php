...
<html lang="en">
  ...
  <body>
          ...
          <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
            ...
            <ul class="navbar-nav navbar-nav-right">
              <li class="nav-item dropdown d-none d-lg-block">
                <a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-bs-toggle="dropdown" aria-expanded="false" href="#">Меню</a>
    ...
    <script src="../admin-panel/js/jquery.cookie.js" type="text/javascript"></script>
    <!-- End plugin js for this page -->
    <!-- inject:js -->
    <script src="../admin-panel/js/off-canvas.js"></script>
    <script src="../admin-panel/js/hoverable-collapse.js"></script>
    <script src="../admin-panel/js/misc.js"></script>
