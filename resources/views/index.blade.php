                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="hero__text">
                                    ...
                                    <h2>Fate / Stay Night: Остаться живым и не умереть</h2>
                                    <p></p>
                            ...
                            @foreach ($trends as $trend)
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="product__item">
                                        <div class="product__item__pic set-bg" data-setbg="storage/{{$trend->img}}">
                                            <div class="ep">Хит!</div>
                                        ...
                                        <div class="product__item__text">
                                            ...
                                            <h5><a href="/anime-details/{{$trend->slug}}">{{ $trend->name }}</a></h5>
                                        </div>
                                    </div>
                                </div>
